...
import "./PrintTemplateDanhSachMucInDaXuat.scss";

export const PrintTemplateDanhSachMucInDaXuat = React.forwardRef(
  (props, ref) => {
    ...
    return (
      <>
        <div className="print-preview_mucindaxuat" ref={ref}>
          <div className="header_mucindaxuat">
            <div className="">
          ...
          <br />
          <h4 className="title_mucindaxuat">DANH SÁCH MỰC IN ĐÃ XUẤT</h4>
          <br />
          <table className="ink-table_mucindaxuat">
            <thead>
              <tr>
                <th>STT</th>
                <th>Tên mực</th>
