...
import "./PrintTemplateChiTietThongKeMucInDaXuat.scss";

export const PrintTemplateChiTietThongKeMucInDaXuat = React.forwardRef(
  (props, ref) => {
    ...
    return (
      <>
        <div className="print-preview" ref={ref}>
          ...
          <h4 className="title">
            <span>
              DANH SÁCH THÔNG TIN CHI TIẾT SỐ LƯỢNG MỰC IN ĐÃ ĐỔI CHO CÁC KHOA
            </span>
          </h4>
          <br />
